  ...
  return (
    <div className="flex bg-white flex-col rounded-xl space-y-6 md:flex-row md:space-x-6 md:space-y-0 items-start ">
      ...
      >
        ...
        <button
          type="submit"
          className="border text-xl border-black hover:bg-black hover:text-white transition duration-200"
        >
          Submit
        </button>
      </form>
      <div className="flex flex-col space-y-3">
        ...
        <div className="max-w-sm">
          <p className={username.color}>
            Username should be between 4-15 characters
          </p>
        </div>
        <p className={email.color}>Please enter valid e-mail</p>
        <div className="max-w-sm">
          <p className={password.color}>
            Password must be include 1 uppercase 1 lowercase 1 number and 1
